...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("MOTOHELMET_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Motohelmet <no-reply@motohelmet.alexedwards.net>", "SMTP sender")
